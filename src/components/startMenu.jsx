        ...
        <div className='startMenuWrapper'>
            ...
            <div className='startContentLeft noselect'>
                <ul>
                    ...
                    <li className='itemList waldo' onMouseLeave={()=> {
                            setHover(false)
                    }} onMouseOver={()=> {
                        if (hover === false) {
                            setHover(true)
                        ...
                        <div className='titleWrap'>
                            <a target="_blank" rel="noopener noreferrer" href='https://paulords95.github.io/WhereIsWaldo/' className='leftTitle'>Onde está Waldo?</a>
                        </div>
                        <a alt='link' target="_blank" rel="noopener noreferrer" href='https://github.com/paulords95/WhereIsWaldo' className={` ${hover ? 'infoTextShow' : 'infoTextHide'}`}>Repositório no GitHub
                            </a>
                        <div className={`${hover ? 'waldoInfo' : ''}`}>
                        </div>
                    </li>
                </ul>
            </div>
